...
namespace Game_Project
{
    class PlayerMoveLeft : ISprite
    {
        ...
        public Texture2D Texture { get; set; } // we still don't have the sprite sheet for the main character moving right or left!!
        ...
        public PlayerMoveLeft(Texture2D texture, Vector2 location, Rectangle windowSize, int rows, int columns)
        {
            Texture = texture;
            ...
            scaleFactor = 4;
            moveFactor = 2; // moveFactor changed to 2 because we don't want our player to zoom past. Will change later.
            animationSpeed = 3; 
        }
        ...
        private void Move()
        {
            ...
            if (location.X == -Texture.Width) // here we need to check if it touches to edge not WindowSize.Width
            {
