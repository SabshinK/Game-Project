...
{
    class AnimatedNonMoving : ISprite
    {
        ...
        public AnimatedNonMoving(Texture2D texture, Vector2 location, Rectangle windowSize, int rows, int columns)
        {
            Texture = texture;
        ...
        // No movement necessary in this class
        public void Update()
        {
            currentFrame++;
